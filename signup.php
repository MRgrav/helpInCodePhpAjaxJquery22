	...
	<div class="flexr w-100 justify-content-center align-items-center" style="height: 100vh;">
		<form class="border p-3 shadow text-center" id="driver_signup">
			...
			<!	<div class="p-2 border" id="pg-A">
					...
					<div hidden class="row p-2 mt-2 wrap-reverse">
			...
			<!	<div class="p-2 border" id="pg-B">
					...
					<div hidden class="row p-2 mt-3 wrap-reverse">
				...
				<!	<div class="row p-2 mt-2">
						...
						<div class="flexr flex-wrap">
							<div class="col-sm-6 p-2">
								<img id="dlImg" src="" class="border p-1 w-100" style="display: none; height: 100%; max-height: 160px; object-fit: cover;">
							...
							<div class="col-sm-6 p-2">
								<img id="pobImg" src="" class="border p-1 w-100" style="display: none; height: 100%; max-height: 160px; object-fit: cover;">
								<input id="pob" type="file" name="dob_photo" hidden accept="image/png, image/jpg, image/jpeg" capture>
