...
$sql_sk = "SELECT * FROM `drivers` WHERE driverId = '$Id' ";
$num = mysqli_num_rows(mysqli_query($conn, $sql_sk));
...
/*if($num > 0){
	...
	(`driverId`, `name`, `phone`, `mail`, `license`, `dob`, `gen`, `pwd`, `profile`, `dl_photo`, `dob_photo`, `status`) VALUES 
	('$Id', '$fname', '$phone', '$mail', '$dl', '$dob', '$gender', '$pwd', '$Path_pr', '$Path_dl', '$Path_db', '$st') ";
